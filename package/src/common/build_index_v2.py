...
# Build the expanded SQLite/FTS5 index required by the LTR pipelines.
DATA_DIR = Path("data")
...
def create_schema(con: sqlite3.Connection) -> None:
    ...
    # Legacy multi-column tables are kept for baseline and weighted BM25 variants.
    ...
    # Single-content FTS tables let each retrieval variant target one field view.
    for table, tokenizer in [
